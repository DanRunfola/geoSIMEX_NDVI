...
%%Suggestion (mcl): Specify that bias introduced because when you aggregate at lower resolution, that data reflects values more characteristic of global effects i.e. mean intensity, and less of the local variation seen at the resolution where the independent variable may have an effect.
